...
[![SalonNote 미용실 고객관리 프로그램 바로가기](/images/salonnote/salonnote-api.png)](https://app.salonnote.uk)
...
미용실 운영처럼 고객 예약, 시술 기록, 정산을 한 번에 관리해야 하는 업무라면 [SalonNote](https://app.salonnote.uk)처럼 웹에서 바로 쓰는 관리 도구가 편합니다.`;
