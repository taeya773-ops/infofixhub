...
export const providerStates = () => [
 ...
 {name:"Google Ads",connected:env.GOOGLE_ADS_ENABLED==="true"&&Boolean(env.GOOGLE_ADS_DEVELOPER_TOKEN&&env.GOOGLE_ADS_CUSTOMER_ID&&env.GOOGLE_ADS_CLIENT_ID&&env.GOOGLE_ADS_CLIENT_SECRET&&env.GOOGLE_ADS_REFRESH_TOKEN)},
